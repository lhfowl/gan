...
# remove gen_images_uniform_random_labels==True to generate one tile of images
# per class. By default 1000 tiles of size BATCH_SIZE will be generated.
export ADDITIONAL='--critic_type=acgan_multiproj \
--mode=gen_images \
--gen_images_with_margins \
--n_images_per_side_to_gen_per_tile=8 \
--gen_images_uniform_random_labels=True'
